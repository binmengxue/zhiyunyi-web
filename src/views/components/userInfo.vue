...
<div  class="userInfo">
    <el-row :gutter="10" class="userInfo_row">
        <el-col :xl="6" :md="8" style="padding:0;">
           <UserElRow  label="姓名："  :info="userData.customerName" spanCol="10" />
        </el-col>
        <el-col :xl="6" :md="8" style="padding:0;">
          <UserElRow  label="民族：" :info="userData.nation" spanCol="10" />
        </el-col>
        <el-col :xl="6" :md="8" style="padding:0;">
          <UserElRow  label="性别："  :info="userData.sex" spanCol="10" />
        </el-col>
        <el-col :xl="6" :md="8" style="padding:4px 0;">
          <el-row type="flex" style="align-items: center;padding-bottom:0; border-bottom:1px solid #f5f2f2;">
            <el-col class="span1" :span='6'>手机号：</el-col>
            <el-col class="span2" :span='6'  v-if="userData.phone" >{{plusXing(userData.phone,3,4)}}</el-col>
            <el-button type="text" style="margin-left:10px;"  @click="openCallPhone(userData.phone)" ><i class="el-icon-phone" style="font-size:20px"></i></el-button>
        ...
        <el-col :xl="6" :md="8" style="clear: both;padding:0;">
        ...
        <el-col :xl="6" :md="8" style="padding:0;">
         ...
         <el-col :xl="6" :md="8" style="padding:0;">
          <UserElRow  label="是否支持划扣："  :info="userData.userId" spanCol="10" />
        </el-col>
        <el-col :xl="6" :md="8" style="padding:0;">
          <UserElRow  label="当前应还本金："  :info="userData.payPrincipalAmount" spanCol="10" />
        </el-col>
        <el-col :xl="6" :md="8" style="padding:0;">
          <UserElRow  label="当前应还利息："  :info="userData.payInterestAmount" spanCol="10" />
        </el-col>
        <el-col :xl="6" :md="8" style="padding:0;">
          <UserElRow  label="当前应还违约金："  :info="userData.payOutContractAmount" spanCol="10" />
        </el-col>
        <el-col :xl="6" :md="8" style="padding:0;">
          <UserElRow  label="当前应还总额："  :info="userData.payTotalAmount" spanCol="10" />
        </el-col>
        <el-col :xl="6" :md="8" style="padding:0;">
            <UserElRow  label="最早应还日期：" :info="payDate" spanCol="10" />
         </el-col>
        <el-col :xl="6" :md="8" style="padding:0;">
            <UserElRow  label="最大逾期天数："  :info="userData.overdueDays" spanCol="10" />
        </el-col>
        <el-col :xl="6" :md="8" style="padding:0;">
            <UserElRow  label="借款人放款总额："  :info="userData.loadPrincipal" spanCol="10" />
        </el-col>
        <el-col :xl="6" :md="8" style="padding:0;">
            <UserElRow  label="借款人已还总额："  :info="userData.platPayTotalAmount" spanCol="10" />
        </el-col>
     <span v-show="isMore">
    
          <el-col :xl="6" :md="8" style="padding:0;">
            <UserElRow  label="身份证地址："  :info="userData.identityAddress" spanCol="10" />
          </el-col>
          <el-col :xl="6" :md="8" style="padding:0;">
            <UserElRow  label="居住地址："  :info="userData.livingAddress" spanCol="10" />
          </el-col>
          <el-col :xl="6" :md="8" style="padding:0;">
            <UserElRow  label="工作地址："  :info="userData.companyAddress" spanCol="10" />
          </el-col>
          <el-col :xl="6" :md="8" style="padding:0;">
            <UserElRow  label="单位名称："  :info="userData.companyName" spanCol="10" />
          </el-col>
          <el-col :xl="6" :md="8" style="padding:0;">
            <UserElRow  label="委托开始时间："  :info="entrustStartTime" spanCol="10" />
          </el-col>
          <el-col :xl="6" :md="8" style="padding:0;">
            <UserElRow  label="委托结束时间："  :info="entrustEndTime" spanCol="10" />
          </el-col>
          <el-col :xl="6" :md="8" style="padding:0;">
            <UserElRow  label="委托时授信状态："  :info="userData.creditStatus" spanCol="10" />
          </el-col>
          <el-col :xl="6" :md="8" style="padding:0;">
            <UserElRow  label="委托时授信金额："  :info="userData.creditAmount" spanCol="10" />
          </el-col>
          <el-col :xl="6" :md="8" style="padding:0;">
            <UserElRow  label="QQ："  :info="userData.qq" spanCol="10" />
          </el-col>
          <el-col :xl="6" :md="8" style="padding:0;">
            <UserElRow  label="微信："  :info="userData.wchatNo" spanCol="10" />
          </el-col>
          <el-col :xl="6" :md="8" style="padding:0;">
            <UserElRow  label="邮箱："  :info="userData.mailAddress" spanCol="10" />
          </el-col>
    </span>
    </el-row>
    
    <div class="el-formDiv" style="text-align: center;background:#efefef;padding:5px 0px;border-bottom:1px solid #e6e6e6">
        <el-button type="text" @click="handleMore" style="width:100%" :icon="isMoreIcon">更多基础信息</el-button>
    </div>
