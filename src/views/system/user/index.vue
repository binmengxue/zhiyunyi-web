        ...
        <el-table v-loading="loading" :data="userList" @selection-change="handleSelectionChange">
          ...
          <el-table-column label="用户类型" align="center" prop="userType" :show-overflow-tooltip="true" >
              <template slot-scope="scope">
                {{handleUserTypeChange(scope.row)}}
            </template>
          </el-table-column>
           <el-table-column label="用户权限范围" align="center" prop="caseScope" :show-overflow-tooltip="true" >
              <template slot-scope="scope">
                {{handleDataScopeChange(scope.row)}}
            </template>
          </el-table-column>
          ...
          <el-col :span="12">
           ...
           <el-col :span="12">
            <el-form-item label="数据权限">
              <el-select v-model="form.caseScope" multiple placeholder="请选择" @change="changeEvent">
                <el-option
                  v-for="dict in dataScopes"
                  :key="dict.dictValue"
                  :label="dict.dictLabel"
                  :value="dict.dictValue"
                ></el-option>
      ...
      this.$refs["form"].validate(valid => {
        if (valid) {
          if (this.form.userId != undefined) {
            console.log(this.form.caseScope)
            if(this.form.caseScope && this.form.caseScope.length>0){
              this.form.caseScope=this.form.caseScope.toString();
            }else{
              this.form.caseScope=""
            }
